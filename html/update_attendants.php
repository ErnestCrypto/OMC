...
<div class="row">
    <div class="col-sm-2" style="border-right:1px solid lightgray;display:flex;justify-content:center;align-items:center">
<img src="https://www.w3schools.com/howto/img_avatar.png" class="rounded-circle" style="width:100%;"
  alt="profile" />
  </div>
  <div style="padding-left:1%" class = "col-sm-6"> 
 <h1 class="h3 mb-15 text-gray-800" >ERNEST AKOTO BAMFO</h1>
 <img src="https://logos-world.net/wp-content/uploads/2020/11/Shell-Logo.png" class="rounded-circle" style="width:10%;"
  alt="logo" />
...
<div class="md-form" >
<i class="fa fa-image prefix grey-text"></i>
<input type="text"  id="logo" class="form-control" value="akotobamfo.eab@gmail.com"
 >
